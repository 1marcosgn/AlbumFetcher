...
class InformationProtocolTests: XCTestCase {
    ...
    func test_Object_ThatConformsInformationProtocol_ShouldContainValidData() {
        ...
        let mockiTunesLink = URL(string: "https://itunes.apple.com/us/album/future-hndrxx-presents-the-wizrd/1448780185?app=music")
        
        /// When
        let sut = MockAlbum(albumName: "Future Hndrxx Presents: The WIZRD", artistName: "Future", imageUrl: mockImageURL, genres: ["Hip-Hop/Rap"], releaseDate: "2019-01-18", copyright: "℗ 2019 Epic Records, a division of Sony Music Entertainment. With Freebandz.", itunesLink: mockiTunesLink)
        ...
        XCTAssertNotNil(sut.itunesLink, "iTunes Link should not be nil")
    }
    ...
    func test_ObjectWithOptionals_ThatConformsInformationProtocol_ShouldContainValidData() {
        ...
        /// When
        let sut = MockAlbum(albumName: mockAlbumName, artistName: mockArtistName, imageUrl: nil, genres: nil, releaseDate: "2019-01-18", copyright: nil, itunesLink: nil)
        ...
        XCTAssertNil(sut.itunesLink, "iTunes Link should be nil")
...
class MockAlbum: InformationProtocol {
    ...
    init(albumName: String, artistName: String, imageUrl: URL?, genres: [String]?, releaseDate: String, copyright: String?, itunesLink: URL?) {
